...
The training team at the Harvard Chan Bioinformatics Core provides bioinformatics training to help biologists become comfortable with using tools to analyse high-throughput sequencing (HTS) data. 
